...
<body style="background-color:#007a8d">
<nav class="navbar navbar-expand-lg sticky-top" style="background-color: gray">
<div class="container-fluid" >
        <a style="color: white" class="navbar-brand" href="index.php"><img src="book.png" alt="logo" width="30" height="30">Universitas</a>
        ...
        <div class="card-container">
            <div class="left">
                <div class="left-container">
                    <h2>Tentang Kami</h2>
                    <p>Alamat:Bogor.XXXX</p>
                    <br>
                    <p>No Telp:+62XXXXXX</p>
                    <br>
                    <br>
                    <br>
                    <br>
                    <br>
                    <br>
                    <p>Copyright:Abednego Wicaksono P</p>
                </div>
            </div>
            <div class="right">
